import { Commodity, User, ProduceListing, Order, Message, PriceData, WantedRequest, Review, SellerProfile } from "./types";
...
export const MOCK_PRODUCE: ProduceListing[] = [
  { id: "p1", sellerId: "f1", sellerRole: "farmer", commodityId: "cassava", variety: "TME 419", quantity: 50, price: 85000, currency: "NGN", negotiable: true, grade: "A", location: "Iseyin", state: "Oyo", availableDate: "2026-08-25", harvestDate: "2026-08-20", minOrder: 10, packaging: "50kg woven bags", storageCondition: "Cool, dry store", status: "active", createdAt: "2026-08-20", photos: ["https://images.unsplash.com/photo-1595854775527-69a8a4470e2c?auto=format&fit=crop&w=800&q=80"], description: "Freshly harvested TME 419 cassava tubers. High yield variety, ready for immediate delivery." },
  { id: "p2", sellerId: "f2", sellerRole: "farmer", commodityId: "sesame", variety: "White", quantity: 100, price: 220000, currency: "NGN", negotiable: true, grade: "export", location: "Zaria", state: "Kaduna", availableDate: "2026-09-01", harvestDate: "2026-08-15", minOrder: 25, packaging: "50kg bags", storageCondition: "Moisture <8%", status: "active", createdAt: "2026-08-18", photos: ["https://images.unsplash.com/photo-1601164151579-7a4d3e3a3e3e?auto=format&fit=crop&w=800&q=80"], description: "Premium white sesame seeds, export-grade quality. Well-dried and cleaned." },
  { id: "p3", sellerId: "a1", sellerRole: "agent", commodityId: "maize", variety: "Yellow Flint", quantity: 200, price: 380000, currency: "NGN", negotiable: false, grade: "B", location: "Lagos", state: "Lagos", availableDate: "2026-08-22", harvestDate: "2026-08-10", minOrder: 50, packaging: "100kg bags", storageCondition: "Dry", status: "active", createdAt: "2026-08-10", photos: ["https://images.unsplash.com/photo-1581594965579-6f4a3f8b6e9e?auto=format&fit=crop&w=800&q=80"], description: "Bulk yellow maize sourced from multiple smallholder farmers. Standard grade, reliable supply." },
  { id: "p4", sellerId: "f3", sellerRole: "farmer", commodityId: "yam", variety: "White Yam", quantity: 30, price: 120000, currency: "NGN", negotiable: true, grade: "A", location: "Nsukka", state: "Enugu", availableDate: "2026-08-28", harvestDate: "2026-08-22", minOrder: 5, packaging: "100kg baskets", storageCondition: "Barn stored", status: "active", createdAt: "2026-08-22", photos: ["https://images.unsplash.com/photo-1601298790258-3c27e0d6c6e3?auto=format&fit=crop&w=800&q=80"], description: "Fresh white yam tubers, farm-fresh quality. Ideal for table yam and pounding." },
  { id: "p5", sellerId: "a2", sellerRole: "agent", commodityId: "rice", variety: "FARO 44", quantity: 150, price: 450000, currency: "NGN", negotiable: true, grade: "A", location: "Ibadan", state: "Oyo", availableDate: "2026-09-05", harvestDate: "2026-08-30", minOrder: 30, packaging: "50kg bags", storageCondition: "Hermetic bags", status: "active", createdAt: "2026-08-15", photos: ["https://images.unsplash.com/photo-1587758322490-8a8e5f7b6a3e?auto=format&fit=crop&w=800&q=80"], description: "Premium FARO 44 parboiled rice. High-yielding variety with excellent milling quality." },
  { id: "p6", sellerId: "f4", sellerRole: "farmer", commodityId: "ginger", variety: "Dry Ginger", quantity: 25, price: 180000, currency: "NGN", negotiable: true, grade: "export", location: "Kano", state: "Kano", availableDate: "2026-10-01", harvestDate: "2026-09-15", minOrder: 5, packaging: "50kg jute bags", storageCondition: "Moisture <10%", status: "active", createdAt: "2026-08-12", photos: ["https://images.unsplash.com/photo-1615485921762-1f2d3e6e8e3e?auto=format&fit=crop&w=800&q=80"], description: "High-quality dry ginger root, export grade. Well-cured and sorted." },
  { id: "p7", sellerId: "e1", sellerRole: "exporter", commodityId: "cocoa", variety: "Forastero", quantity: 500, price: 2500000, currency: "NGN", negotiable: true, grade: "export", location: "Ondo", state: "Ondo", availableDate: "2026-11-01", harvestDate: "2026-09-30", minOrder: 100, packaging: "60kg bags", storageCondition: "Dry warehouse", status: "active", createdAt: "2026-08-01", photos: ["https://images.unsplash.com/photo-1574267249476-2b7d8e8f3a5e?auto=format&fit=crop&w=800&q=80"], description: "Bulk Fermented Forastero cocoa beans. Export-quality, well-fermented and dried." },
  { id: "p8", sellerId: "f5", sellerRole: "farmer", commodityId: "cashew", variety: "Raw", quantity: 80, price: 320000, currency: "NGN", negotiable: true, grade: "A", location: "Ondo", state: "Ondo", availableDate: "2026-09-10", harvestDate: "2026-08-25", minOrder: 20, packaging: "50kg bags", storageCondition: "Ventilated", status: "active", createdAt: "2026-08-18", photos: ["https://images.unsplash.com/photo-1606904063415-9e8d0d5a9d8e?auto=format&fit=crop&w=800&q=80"], description: "Raw cashew nuts, grade A quality. Well-sorted and naturally sun-dried." },
  { id: "p9", sellerId: "a3", sellerRole: "agent", commodityId: "soybean", variety: "TGX", quantity: 120, price: 280000, currency: "NGN", negotiable: true, grade: "B", location: "Kano", state: "Kano", availableDate: "2026-09-15", harvestDate: "2026-09-01", minOrder: 25, packaging: "50kg bags", storageCondition: "Dry", status: "active", createdAt: "2026-08-14", photos: ["https://images.unsplash.com/photo-1584395630827-aae612a0c2c6?auto=format&fit=crop&w=800&q=80"], description: "TGX soybean variety, high protein content. Aggregated from multiple farms." },
  { id: "p10", sellerId: "f1", sellerRole: "farmer", commodityId: "tomato", variety: "Roma", quantity: 15, price: 45000, currency: "NGN", negotiable: true, grade: "A", location: "Iseyin", state: "Oyo", availableDate: "2026-08-26", harvestDate: "2026-08-23", minOrder: 2, packaging: "25kg crates", storageCondition: "Cold chain", status: "active", createdAt: "2026-08-23", photos: ["https://images.unsplash.com/photo-1601293656429-8e3e2a4f5e3e?auto=format&fit=crop&w=800&q=80"], description: "Fresh Roma tomatoes, greenhouse-grown. Ready for immediate supply." },
];
...
export const MOCK_WANTED_REQUESTS: WantedRequest[] = [
  { id: "w1", requesterId: "b1", requesterRole: "buyer", commodityId: "rice", quantity: 200, unit: "tonne", budget: 85000, budgetCurrency: "NGN", negotiable: true, location: "Lagos", state: "Lagos", deliveryMethod: "delivery", notes: "Seeking 200 tonnes of parboiled rice for monthly supply. Quality grade A required.", status: "open", createdAt: "2026-08-20", photos: [] },
  { id: "w2", requesterId: "b2", requesterRole: "buyer", commodityId: "cassava", variety: "TME 419", quantity: 500, unit: "tonne", budget: 75000, budgetCurrency: "NGN", negotiable: true, location: "Kaduna", state: "Kaduna", deliveryMethod: "pickup", notes: "Large buyer needs 500 tonnes of cassava for processing. Consistent supply needed.", status: "open", createdAt: "2026-08-18", photos: [] },
  { id: "w3", requesterId: "b3", requesterRole: "buyer", commodityId: "tomato", quantity: 50, unit: "tonne", budget: 90000, budgetCurrency: "NGN", negotiable: true, location: "Abuja", state: "FCT", deliveryMethod: "delivery", notes: "Fresh tomatoes needed weekly. Grade A, ready for market.", status: "open", createdAt: "2026-08-22", photos: [] },
  { id: "w4", requesterId: "e1", requesterRole: "exporter", commodityId: "cocoa", quantity: 1000, unit: "tonne", budget: 3200000, budgetCurrency: "NGN", negotiable: false, location: "Ondo", state: "Ondo", deliveryMethod: "courier", notes: "Export buyer seeking 1000 tonnes of fermented Forastero cocoa beans. FOB terms. Phytosanitary certificate required.", status: "open", createdAt: "2026-08-15", photos: [] },
  { id: "w5", requesterId: "b1", requesterRole: "buyer", commodityId: "soybean", quantity: 100, unit: "tonne", budget: 300000, budgetCurrency: "NGN", negotiable: true, location: "Port Harcourt", state: "Rivers", deliveryMethod: "delivery", notes: "Soymeal processor needs 100 tonnes of TGX soybeans. Monthly recurring order.", status: "open", createdAt: "2026-08-19", photos: [] },
];

export const MOCK_REVIEWS: Review[] = [
  { id: "r1", orderId: "AGN-2026-000145", reviewerId: "b1", revieweeId: "f1", rating: 5, comment: "Excellent quality cassava, delivered on time. Will order again.", createdAt: "2026-08-23" },
  { id: "r2", orderId: "AGN-2026-000146", reviewerId: "b2", revieweeId: "f2", rating: 4, comment: "Good sesame, slight delay in delivery but quality was top-notch.", createdAt: "2026-08-22" },
];

export const MOCK_SELLER_PROFILES: SellerProfile[] = [
  { id: "f1", role: "farmer", name: "Adebayo Ogundimu", description: "Third-generation cassava and tomato farmer in Iseyin. Specializes in TME 419 cassava varieties and Roma tomatoes using sustainable practices. Certified by the Nigerian Agricultural Quarantine Service.", avatar: "https://images.unsplash.com/photo-1595854775527-69a8a4470e2c?auto=format&fit=crop&w=200&q=80", verificationLevel: "trade_verified", rating: 4.8, state: "Oyo", lga: "Iseyin", joinedDate: "2025-03-15", produceCount: 2, tags: ["Cassava", "Tomatoes", "Sustainable Farming"] },
  { id: "f2", role: "farmer", name: "Fatima Ibrahim", description: "Seed farmer specializing in high-quality sesame production in Zaria. Export-grade quality with strict moisture control. Member of the Kaduna State Farmers Association.", avatar: "https://images.unsplash.com/photo-1542838132-92c53300491e?auto=format&fit=crop&w=200&q=80", verificationLevel: "trusted", rating: 4.9, state: "Kaduna", lga: "Zaria", joinedDate: "2025-01-20", produceCount: 1, tags: ["Sesame", "Export Quality", "Seed Production"] },
  { id: "f3", role: "farmer", name: "Chukwuemeka Nwosu", description: "Yam farmer in Nsukka with 15 years of experience. Grows premium white yam using traditional methods passed down through generations.", avatar: "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&w=200&q=80", verificationLevel: "identity_verified", rating: 4.5, state: "Enugu", lga: "Nsukka", joinedDate: "2025-05-10", produceCount: 1, tags: ["Yam", "Traditional Farming"] },
  { id: "a1", role: "agent", name: "Lagos Agro Services Ltd", description: "Marketing agent aggregating produce from smallholder farmers across Lagos State. We connect farmers to large buyers and handle bulk logistics.", avatar: "https://images.unsplash.com/photo-1576582527649-d162a3e333e9?auto=format&fit=crop&w=200&q=80", verificationLevel: "trusted", rating: 4.7, state: "Lagos", lga: "Lagos Mainland", joinedDate: "2024-09-01", produceCount: 1, tags: ["Aggregation", "Bulk Supply", "Logistics"] },
  { id: "e1", role: "exporter", name: "West Africa Export Ltd", description: "Export trading company specializing in West African agricultural commodities. We source high-quality cocoa, cashew, and sesame for international markets.", avatar: "https://images.unsplash.com/photo-1595854775527-69a8a4470e2c?auto=format&fit=crop&w=200&q=80", verificationLevel: "trusted", rating: 4.9, state: "Lagos", lga: "Lagos Island", joinedDate: "2024-08-20", produceCount: 1, tags: ["Export", "Cocoa", "Cashew", "Sesame"] },
];

export function getWantedRequestById(id: string): WantedRequest | undefined {
  return MOCK_WANTED_REQUESTS.find(w => w.id === id);
}

export function getSellerProfile(id: string): SellerProfile | undefined {
  return MOCK_SELLER_PROFILES.find(s => s.id === id);
}

export function getSellerProduce(sellerId: string): ProduceListing[] {
  return MOCK_PRODUCE.filter(p => p.sellerId === sellerId);
}

export function getReviewsForSeller(sellerId: string): Review[] {
  return MOCK_REVIEWS.filter(r => r.revieweeId === sellerId);
}

export function getWantedRequestsByState(state: string): WantedRequest[] {
  return MOCK_WANTED_REQUESTS.filter(w => w.state === state);
}
